...
fn is_amp_body(t: tkn.Token) bool {
    return t.symbol == .Word or t.symbol == .Underscore or t.symbol == .Colon or t.symbol == .Ampersand or t.symbol == .Dot or t.symbol == .Tilde or t.symbol == .Minus or t.symbol == .Plus or t.symbol == .Equal or t.symbol == .Dollar or t.symbol == .Hat or t.symbol == .Exclamation or t.symbol == .At or t.symbol == .Questionmark or t.symbol == .Hashtag;
}
